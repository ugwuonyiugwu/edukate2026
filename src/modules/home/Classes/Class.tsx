...
const LEVELS = [
  {
    id: 'Basic',
    title: 'Basic Tier',
    desc: 'Comprehensive foundational training for students. Master the core concepts and essential subject principles required to excel in higher classes.',
    icon: BookOpen,
  ...
  },
  {
    id: 'Mastery',
    title: 'Mastery Tier',
    desc: 'Comprehensive coverage of the intermidiate curriculum. This tier bridges the gap between core fundamentals and advanced exam preparation, focusing on in-depth topic analysis and practical application.',
    icon: Zap,
    color: 'bg-[#E7F9EE] text-[#00C7B1]',
    btnColor: 'bg-[#E7F9EE] text-[#00C7B1] hover:bg-green-100'
  },
  {
    id: 'Professional',
    title: 'Professional Tier',
    desc: 'The ultimate preparation for SS3 scholars. Focused on advanced curriculum mastery, intensive simulations, and strategic pathways for higher learning.',
    icon: Crown,
      ...
      >
        {LEVELS.map((level) => (
          ...
          >
            ...
            <h2 className="text-xl lg:text-2xl font-black text-blue-950 mb-3 tracking-tight uppercase">
              {level.title}
            </h2>
