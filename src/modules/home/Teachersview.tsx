      ...
      <div className="mb-6">
        ...
        <div className="my-5 text-center">
           <h1 className="text-4xl font-black text-slate-900 mb-4 tracking-tight uppercase">
            ...
            <p>Meet with qualified instructors in every field </p>
        </div>
        ...
        <div className="relative group">
          ...
          <Input
            ...
            className="pl-10 h-12 rounded-xl border-slate-200 shadow-sm focus:ring-blue-500/10 transition-all text-sm bg-white"
            value={searchQuery}
      ...
      <div className="space-y-3">
        {filteredTeachers.map((teacher) => (
          ...
          >
            ...
            <div className="flex items-center justify-center px-3 sm:px-6 h-full bg-slate-50/50 min-w-[60px] sm:min-w-[100px] border-r border-dashed border-slate-200 relative shrink-0">
            ...
            <div className="px-2 sm:px-6 h-full flex items-center shrink-0">
              ...
              >
                ...
                >
                  <MessageCircle className="w-3 h-3 sm:w-4 h-4 fill-current" />
                  <span>Apply</span>
                </a>
              </Button>
            </div>
