    ...
    <div className="min-h-screen bg-gray-100/50 py-10 px-4"> 
      <div className="max-w-2xl mx-auto p-8 bg-white shadow-md rounded-3xl border border-gray-100">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          {/* Points Badge - Non-editable as per schema default */}
          <div className="mt-2 flex items-center gap-2 bg-yellow-50 text-yellow-700 px-4 py-1.5 rounded-full border border-yellow-200">
        ...
        <form onSubmit={handleSubmit((data) => update.mutate(data))} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-1.5">
              <label className="text-[11px] font-bold uppercase text-gray-500 ml-1 flex items-center gap-1">
                <MapPin size={12} /> State of Origin:
              </label>
              <input {...register("state")} placeholder="e.g. California" className="w-full border border-gray-200 rounded-xl p-3.5 bg-gray-50/50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" />
            </div>
          </div>
