...
export const LibraryDetailsView = ({ libraryId }: LibraryDetailsViewProps) => {
  ...
  return (
    <div className="px-6 md:px-10 max-w-7xl mx-auto min-h-screen bg-[#FAFAFA]">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-15">
        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">{library.name}</h1>
