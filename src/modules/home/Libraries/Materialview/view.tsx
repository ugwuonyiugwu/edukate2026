...
export const DocumentDetailView = ({ documentId, libraryId }: { documentId: number, libraryId: number }) => {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 p-6 md:px-10 animate-in fade-in duration-300">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7 space-y-8">
          <div>
            ...
            <div className="p-4 bg-gray-100 border border-gray-100 font-bold">{doc.name}</div>
        </div>
        <div>
            <p className="text-xs font-black uppercase text-gray-400 mb-2">Description</p>
            <div className="w-full p-6 bg-gray-100 border border-gray-100 text-gray-600 min-h-62.5 leading-relaxed text-lg font-medium">
                {doc.description ? (
          ...
          <div>
            ...
            <div className="p-4 bg-gray-100 border border-gray-100 rounded-xl w-64 font-bold">{doc.subject}</div>
          </div>
        </div>
