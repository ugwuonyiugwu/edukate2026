...
export function QuizContent() {
  ...
  return (
    <section className="w-full max-w-5xl bg-[#0a1128] rounded-sm p-6 sm:p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
      <div className="absolute top-2 left-2 md:top-5 md:left-5 w-20 h-20 md:w-32 md:h-32 border-[3px] border-blue-600 rounded-full opacity-20 pointer-events-none" />
      <div className="absolute bottom-5 right-5 w-16 h-16 md:w-24 md:h-24 border-[3px] border-pink-500/30 rounded-full pointer-events-none" />
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col items-center gap-2">
           <p className="text-base sm:text-lg text-slate-300 font-medium italic">
             Entry Fee: {quiz.pointCost} Points
           </p>
