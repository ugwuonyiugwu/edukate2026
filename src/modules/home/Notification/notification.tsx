...
// Helper function to turn raw URLs into interactive anchor tags
const renderMessageWithLinks = (text: string) => {
  ...
  return parts.map((part, index) => {
    ...
    const isUrl = urlRegex.test(part) || part.startsWith("http") || part.startsWith("www");
    if (isUrl) {
      ...
      return (
        <a
          ...
          className="text-blue-600 font-semibold underline hover:text-blue-800 break-all inline-block"
            ...
            notes.map((note) => (
              ...
              >
                ...
                <div className="flex-1 overflow-hidden">
                  <p className="font-bold text-sm md:text-base text-gray-900 wrap-break-words leading-relaxed">
