    ...
    <footer className="bg-slate-950 text-slate-300 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <SocialLink href="https://www.instagram.com/edukate447" icon={<SiInstagram size={18} />} label="Instagram" />
              <SocialLink href="#" icon={<Linkedin size={18} />} label="LinkedIn" />
              <SocialLink href="https://wa.me/$8129156454" icon={<SiWhatsapp size={18} />} label="GitHub" />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="/classes" className="hover:text-primary transition-colors">Digital Library</a></li>
              <li><a href="/quizathon" className="hover:text-primary transition-colors">Mock Assessments</a></li>
              <li><a href="/scholarship" className="hover:text-primary transition-colors">Scholarship Programs</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><a href="/teachers" className="hover:text-primary transition-colors">Student Mentorship</a></li>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-slate-500">
          <p>© 2026 Edukate Repository. Empowering students globally.</p>
