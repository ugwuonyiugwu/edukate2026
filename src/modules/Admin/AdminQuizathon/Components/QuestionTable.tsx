...
export function QuestionTable({ quizId, subject }: { quizId: number, subject: string }) {
  ...
  // 🛡️ Updated path to target the 'adminquizathon' router namespace
  const [questions] = trpc.adminquizathon.getQuestionsBySubject.useSuspenseQuery({ quizId, subject });
  
  // 🛡️ Updated mutation and cache invalidation pathways to use 'adminquizathon'
      ...
      <Table>
        <TableHeader className="bg-slate-50/50">
          <TableRow className="hover:bg-transparent">
            ...
            <TableHead className="font-bold text-green-600">CORRECT</TableHead>
